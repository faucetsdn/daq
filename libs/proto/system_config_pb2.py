...
_sym_db.RegisterEnumDescriptor(_TESTTRIGGERTYPE)

TestTriggerType = enum_type_wrapper.EnumTypeWrapper(_TESTTRIGGERTYPE)
PORT = 0
VLAN = 1
...
_DAQCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='test_trigger_type', full_name='DaqConfig.test_trigger_type', index=37,
...
_DAQCONFIG.fields_by_name['test_trigger_type'].enum_type = _TESTTRIGGERTYPE
...
DESCRIPTOR.enum_types_by_name['TestTriggerType'] = _TESTTRIGGERTYPE
