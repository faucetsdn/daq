...
_DAQCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_dhcp_subnets', full_name='DaqConfig.external_dhcp_subnets', index=41,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mininet_subnet', full_name='DaqConfig.mininet_subnet', index=42,
...
_DAQCONFIG.fields_by_name['external_dhcp_subnets'].message_type = _IPSUBNET
_DAQCONFIG.fields_by_name['mininet_subnet'].message_type = _IPSUBNET
