...
_SWITCHSETUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alt_port', full_name='SwitchSetup.alt_port', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lo_addr', full_name='SwitchSetup.lo_addr', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mods_addr', full_name='SwitchSetup.mods_addr', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='of_dpid', full_name='SwitchSetup.of_dpid', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_intf', full_name='SwitchSetup.data_intf', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ext_br', full_name='SwitchSetup.ext_br', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='model', full_name='SwitchSetup.model', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='username', full_name='SwitchSetup.username', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='password', full_name='SwitchSetup.password', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vxlan', full_name='SwitchSetup.vxlan', index=14,
