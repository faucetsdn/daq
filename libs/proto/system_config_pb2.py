...
_SWITCHSETUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gauge_port', full_name='SwitchSetup.gauge_port', index=5,
