...
VxlanSetup = _reflection.GeneratedProtocolMessageType('VxlanSetup', (_message.Message,), dict(
...
_DAQCONFIG_INTERFACESENTRY.has_options = True
_DAQCONFIG_INTERFACESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_DAQCONFIG_FAILMODULEENTRY.has_options = True
_DAQCONFIG_FAILMODULEENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
