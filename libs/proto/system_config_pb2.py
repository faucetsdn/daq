...
_DAQCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='faucet_event_timeout_sec', full_name='DaqConfig.faucet_event_timeout_sec', index=44,
...
_SWITCHSETUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vxlan', full_name='SwitchSetup.vxlan', index=13,
