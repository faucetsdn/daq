...
_DAQCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='test_vlan_range', full_name='DaqConfig.test_vlan_range', index=40,
...
_TESTVLANRANGE = _descriptor.Descriptor(
  name='TestVLANRange',
  full_name='TestVLANRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='vlan_start', full_name='TestVLANRange.vlan_start', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vlan_end', full_name='TestVLANRange.vlan_end', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DAQCONFIG.fields_by_name['test_vlan_range'].message_type = _TESTVLANRANGE
...
DESCRIPTOR.message_types_by_name['TestVLANRange'] = _TESTVLANRANGE
...
TestVLANRange = _reflection.GeneratedProtocolMessageType('TestVLANRange', (_message.Message,), dict(
  DESCRIPTOR = _TESTVLANRANGE,
  __module__ = 'daq.proto.system_config_pb2'
  # @@protoc_insertion_point(class_scope:TestVLANRange)
  ))
_sym_db.RegisterMessage(TestVLANRange)
