...
Message envelope attributes, automatic for each message ([example](envelope.tests/example.json)).
* [<em>metadata</em>](metadata.json):
Device metadata, information _about_ a device ([example](metadata.tests/example.json)).
