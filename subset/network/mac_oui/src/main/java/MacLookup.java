...
public class MacLookup {
  ...
  public void startTest() {
    System.out.println("Starting connection.network.mac_oui test...");
    ...
    try {
      ...
      reportHandler.addText("RESULT pass connection.network.mac_oui Manufacturer: "
      ...
      reportHandler.addText("RESULT fail connection.network.mac_oui Manufacturer prefix not found!");
      reportHandler.writeReport();
