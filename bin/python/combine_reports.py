...
def main(device, start=None, end=None, gcp=None, reports_dir=DEFAULT_REPORTS_DIR,
         count=0, daq_run_id=None):
...
if __name__ == '__main__':
    ...
    if CONFIG.get('gcp_cred') and CONFIG.get('from_gcp'):
        ...
        assert not CONFIG.get('from_gcp'), 'missing gcp_cred definition'
