...
class Gateway():
    ...
    def _initialize(self):
        ...
        host.activate()
        self.host = host
        self.host.cmd('./change_leasetime %s' % self.runner.config.get("initial_dhcp_lease_time"))
    ...
    def activate(self):
        ...
        self.host.cmd('./change_leasetime %s' % self.runner.config.get("dhcp_lease_time"))
        self.activated = True
        self._scan_finalize()
