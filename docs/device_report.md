...
| Test             |                        |
|------------------|------------------------|
| Test report start date | 2020-03-03 14:57:56+00:00 |
| Test report end date   | 2020-03-03 15:05:48+00:00 |
| DAQ version      | 1.0.1 |
| Attempt number   | 1 |
...
See log above
--------------------
RESULT pass base.target.ping target reached %% 10.20.23.164
...
--------------------
# Nmap 7.60 scan initiated Tue Mar  3 15:04:41 2020 as: nmap -v -n -Pn -T5 -sU -sT --open -pU:47808,T:23,443,80, -oG /tmp/nmap.log 10.20.23.164
# Ports scanned: TCP(3;23,80,443) UDP(1;47808) SCTP(0;) PROTOCOLS(0;)
Host: 10.20.23.164 ()	Status: Up
Host: 10.20.23.164 ()	Ports: 47808/open|filtered/udp//bacnet///	Ignored State: closed (3)
# Nmap done at Tue Mar  3 15:04:41 2020 -- 1 IP address (1 host up) scanned in 0.66 seconds
...
```
--------------------
Collecting TLS cert from target address %% 10.20.23.164
